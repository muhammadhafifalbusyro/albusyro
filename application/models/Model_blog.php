    ...
    public function get_data_blog()
    {
        $data = [
            [
                ...
                "isi" =>
                '
                <p style="font-weight:bold;font-size:16px;line-height:1.5">Pendahuluan</p>
                <p>
                ...
                <p>
                Hasil teknologi telah sejak lama dimanfaatkan dalam pendidikan. Penemuan kertas, mesin cetak, radio, film, TV, komputer dan lain-lain itu dimanfaatkan bagi pendidikan. Pada hakekatnya alat-alat tersebut tidak dibuat khusus untuk keperluan pendidikan, akan tetapi alat-alat tersbut ternyata dapat dimanfaatkan dalam dunia pendidikan.
                </p>
                <p>
                ...
                <p style="font-weight:bold;font-size:16px;line-height:1.5">
                ...
                <p>
                Budiman, Haris. 2017. Peran Teknologi Inforamsi Dan Komunikasi Dalam Pendidikan. Al-Tadzkiyyah: Jurnal Pendidikan Islam, Volume 8, Mei 2017. Lampung.<br>
                Riana, Cepi. 2018. PERANAN TEKNOLOGI DALAM PEMBELAJARAN. Universitas Pendidikan Indonesia. Bandung.<br>
                Sudibyo, Lies. 2011 Peranan dan Dampak Teknologi Informasi dalam Dunia Pendidikan di Indonesia. Sukoharjo
                </p>
                <p>Sumber: 
                <a href="https://www.kompasiana.com/tutinamaku/5bcaf02643322f2c44578c72/peranan-teknologi-dalam-dunia-pendidikan?page=all">Link artikel<a></p>
                '
            ],
            [
                ...
                '
                    <p>
                    Terkadang merasa benar itu tidak salah, karena kebenaran yang kita rasakan adalah dari data yang kita tahu dan kita pahami. Iyaiyalah, kita semua kan manusia, kita selalu belajar dari setiap kejadian yang kita jalani sepanjang hidup kita, sehingga dari seringnya kejadian yang kita alami, kita bisa memastikan kebenaran dari suatu persepsi.
                    </p>
                    <p>
